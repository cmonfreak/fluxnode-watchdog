...
async function auto_update() {
 ...
 var config = require('./config.js');
 var remote_version = shell.exec("curl -sS https://raw.githubusercontent.com/RunOnFlux/fluxnode-watchdog/development/package.json | jq -r '.version'",{ silent: true }).stdout;
